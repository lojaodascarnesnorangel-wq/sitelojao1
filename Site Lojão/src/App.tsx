...
const PRODUCTS = {
  BOVINAS: [
    { name: "Acém com osso", price: "27,90" },
    { name: "Acém sem osso", price: "36,90" },
    { name: "Paleta com osso", price: "28,90" },
    { name: "Paleta sem osso", price: "39,90" },
    { name: "Peito bovino com osso", price: "26,90" },
    { name: "Costela bovina", price: "26,90" },
    { name: "Braço/Chambaril", price: "25,90" },
    { name: "Suan bovino", price: "19,90" },
    { name: "Bistequinha bovina", price: "29,90" },
    { name: "Bisteca paulista", price: "29,90" },
    { name: "Costelinha do peito", price: "25,50" },
    { name: "Músculo sem osso", price: "32,90" },
    { name: "Guisadinho bovino", price: "32,90" },
    { name: "Bife especial", price: "44,90" },
    { name: "Carne de sol", price: "48,90" },
    { name: "Isca de sol", price: "48,90" },
    { name: "Bife de lombo bovino", price: "44,90" },
    { name: "Coxão mole", price: "48,90" },
    { name: "Chã de fora", price: "48,90" },
    { name: "Alcatra bovina", price: "48,90" },
    { name: "Patinho bovino", price: "48,90" },
    { name: "Contra filé", price: "49,90" },
    { name: "Fraldinha bovina", price: "48,90" },
    { name: "Capa de filé", price: "48,90" },
    { name: "Cupim B", price: "39,90" },
    { name: "Cupim grill", price: "49,90" },
    { name: "Bananinha", price: "48,90" },
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-brand-light font-sans text-brand-black overflow-x-hidden pb-10">
      ...
      {/* Sticky Fixed Mobile Button (Bottom) */}
      <div className="fixed bottom-6 left-6 right-6 z-50 md:hidden">
        <motion.a
          ...
          href={BASE_WA_URL}
          onClick={trackWhatsAppClick}
          className="flex items-center justify-center gap-3 btn-3d-green py-4 rounded-2xl font-bold"
        >
